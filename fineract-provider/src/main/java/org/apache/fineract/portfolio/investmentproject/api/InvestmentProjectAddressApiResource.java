...
@Path("/v1/investmentProjectAddress")
@Component
@Tag(name = "InvestmentProjectAddress", description = "Investment Project Address api resource")
@RequiredArgsConstructor
public class InvestmentProjectAddressApiResource {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "403", description = "Investment project address can not be created") })
    public String addProjectAddress(@Parameter(hidden = true) final String apiRequestBodyAsJson, @PathParam("investmentProjectId") final String investmentProjectId) {
