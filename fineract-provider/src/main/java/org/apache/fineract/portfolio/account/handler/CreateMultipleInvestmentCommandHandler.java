...
@CommandType(entity = "ACCOUNTTRANSFER", action = "CREATE_MULTIPLE_INVESTMENT")
public class CreateMultipleInvestmentCommandHandler implements NewCommandSourceHandler {
