...
@CommandType(entity = "ADDITIONAL_EXPENSES", action = "UPDATE")
public class UpdateAdditionalExpensesCommandHandler implements NewCommandSourceHandler {
    private final AdditionalExpensesWritePlatformService additionalExpensesWritePlatformService;

    @Override
    public CommandProcessingResult processCommand(JsonCommand command) {
        return additionalExpensesWritePlatformService.updateAdditionalExpenses(command);
    }
}
