...
@CommandType(entity = "ADDITIONAL_EXPENSES", action = "DELETE")
public class DeleteAdditionalExpensesCommandHandler implements NewCommandSourceHandler {
    private final AdditionalExpensesWritePlatformService additionalExpensesWritePlatformService;

    @Override
    public CommandProcessingResult processCommand(JsonCommand command) {
        return additionalExpensesWritePlatformService.deleteAdditionalExpensesById(command);
    }
}
