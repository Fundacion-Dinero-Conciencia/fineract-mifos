...
public class QuestionAnswerConstants {
    ...
    /**
     * These parameters will match the class level parameters of {@link BelatQuestion}. Where possible, we try to
     * get response parameters to match those of request parameters.
     */
    public static final Set<String> QUESTION_PARAMETERS = new HashSet<>(Arrays.asList(questionTitleParamName, questionParamName, userIdParamName));

    /**
     * These parameters will match the class level parameters of {@link BelatAnswer}. Where possible, we try to
     * get response parameters to match those of request parameters.
     */
