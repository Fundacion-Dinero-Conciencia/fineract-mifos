...
@Entity
@NoArgsConstructor
@Table(name = "e_project_status_history")
public class StatusHistoryProject extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    @ToString.Exclude
    @OneToOne
    @JoinColumn(name = "status_value_id", nullable = false, referencedColumnName = "id")
    private CodeValue statusValue;
